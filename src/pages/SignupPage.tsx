        ...
        <div className="hidden md:block m-2 border rounded-xl overflow-hidden relative">
          ...
          >
            ...
            <div className="relative pb-8">
              <h3 className="text-xs uppercase text-muted-foreground font-medium mb-8 text-center">OUR CUSTOMERS</h3>
              <div className="relative overflow-hidden">
                ...
                <div className="overflow-hidden">
                  <motion.div
                    className="flex"
                    animate={{ x: [0, -1920] }} // Increased scroll distance for more logos
                    transition={{
                      x: {
                        repeat: Infinity,
                        repeatType: "loop",
                        duration: 40, // Increased duration for smoother scroll with more items
                        ease: "linear",
                      },
                    }}
                  >
                    {/* First set of logos */}
                    <div className="flex-shrink-0 flex items-center space-x-20 px-6">
                      {[
                        { name: "Decathlon", file: "Decathlon.webp" },
                        { name: "Google", file: "Google.webp" },
                        { name: "Urent", file: "Urent.webp" },
                        { name: "Alibaba", file: "alibaba.webp" },
                        { name: "DHL", file: "dhl.webp" },
                        { name: "Faysal Funds", file: "faisal-logo.svg" },
                        { name: "Khazana", file: "khazana.webp" },
                        { name: "Koinz", file: "koinz.webp" },
                        { name: "Meta", file: "meta.webp" },
                        { name: "Saal", file: "saal.png" },
                        { name: "Telegram", file: "telegram.webp" },
                        { name: "Vodafone", file: "vodafone.webp" }
                      ].map((logo) => (
                        <div key={logo.name} className="h-10 flex items-center justify-center">
                          <img
                            src={`/logos/${logo.file}`}
                            alt={logo.name}
                    ...
                    <div className="ml-10 flex-shrink-0 flex items-center space-x-20 px-6">
                      {[
                        { name: "Decathlon", file: "Decathlon.webp" },
                        { name: "Google", file: "Google.webp" },
                        { name: "Urent", file: "Urent.webp" },
                        ...
                        <div key={`${logo.name}-dup`} className="h-10 flex items-center justify-center">
                          <img
                            src={`/logos/${logo.file}`}
                            alt={logo.name}
                            className="h-8 w-auto opacity-70 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300"
